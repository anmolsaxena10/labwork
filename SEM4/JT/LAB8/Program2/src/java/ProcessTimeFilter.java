...
public class ProcessTimeFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            //log("ProcessTimeFilter:DoBeforeProcessing");
        }
        ...
        Date start = new Date();
        req.setAttribute("startTimeFilter", start);
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("ProcessTimeFilter:DoAfterProcessing");
        }
        ...
        Date end = new Date();
        Date start = (Date)req.getAttribute("startTimeFilter");
        long diff = end.getTime()-start.getTime();
        req.getServletContext().log("Process time for"+req.getServerName()+" from Filter: "+diff+" ms");
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("ProcessTimeFilter:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("ProcessTimeFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("ProcessTimeFilter(");
